...
export const metadata: Metadata = {
  ...
  title: {
    default: "LandSync - Dashboard Management System",
    template: "%s | LandSync",
  },
  description:
    "LandSync - Modern dashboard management system for managing users, donations, projects, and leader requests. Streamline your workflow with our intuitive admin panel.",
  keywords: [
    "LandSync",
    "Dashboard",
    "Management System",
  ...
  openGraph: {
    ...
    url: "/",
    siteName: "LandSync",
    title: "LandSync - Dashboard Management System",
    description:
