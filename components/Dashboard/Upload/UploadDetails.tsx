                  ...
                  <div className="grid gap-2">
                    ...
                    {watchCoverImage ? (
                      ...
                      <div
                        ...
                        className="w-full aspect-3/4 max-w-[200px] bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50   transition-colors"
                      >
