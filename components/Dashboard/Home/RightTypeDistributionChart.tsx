...
const data = [
  ...
  { name: "Agricultural", value: 28, color: "#C084FC" }, // Purple - Bottom Right
  { name: "Industrial", value: 24, color: "#615FFF" },   // Dark Blue - Bottom Left
  { name: "Residential", value: 28, color: "#6FD195" },  // Green - Top Left
];
...
const renderCustomizedLabel = (props: any) => {
  ...
  const ex = mx + (cos >= 0 ? 1 : -1) * 120; // Horizontal line length increased
  const ey = my;
  ...
  return (
    <g>
      ...
      <text
        ...
        fill="#6B7280" // text-secondary color usually
        fontSize={13}
        fontWeight={500}
      >
        {payload.name}
