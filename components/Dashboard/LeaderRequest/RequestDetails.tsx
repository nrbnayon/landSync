    ...
    <div className="w-full space-y-8 pb-10">
      ...
      <div>
        ...
        {coverImage ? (
          ...
          <label className="w-[120px] h-[120px] bg-white border border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50   transition-colors mb-2">
            <input
              type="file"
              accept="image/*"
