      ...
      <div className="space-y-2">
        ...
        {formData.coverImage ? (
          ...
          <div
            ...
            className="w-[300px] h-[180px] bg-white dark:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50   transition-colors mt-2"
          >
